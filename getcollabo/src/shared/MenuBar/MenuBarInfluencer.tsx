...
import NavMobileInfluencer from "shared/Navigation/NavMobileInfluencer";

export interface MenuBarProps {
  influencerDataProp?: string;
}

const MenuBarInfluencer: React.FC<MenuBarProps> = ({influencerDataProp}) => {
            ...
            <React.Fragment>
              ...
              >
                <div className="relative z-10">
                  <NavMobileInfluencer secondDataProp={influencerDataProp} onClickClose={handleCloseMenu} />
                </div>
              </Transition.Child>
...
export default MenuBarInfluencer;
