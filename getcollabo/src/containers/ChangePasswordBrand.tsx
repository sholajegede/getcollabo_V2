...
export interface ChangePasswordBrandProps {
  className?: string;
}

const ChangePasswordBrand: FC<ChangePasswordBrandProps> = ({ className = "" }) => {
  ...
  const handlePasswordReset = async (e) => {
    ...
    try {
      ...
      const changePassword = await newRequest.post(`/auth-brand/reset-password/${brand._id}`, sendPassword);
  ...
  return (
    <div className={`nc-ChangePasswordBrand ${className}`} data-nc-id="ChangePasswordBrand">
      <Helmet>
        <title>Brand Password Reset - GetCollabo</title>
      </Helmet>
