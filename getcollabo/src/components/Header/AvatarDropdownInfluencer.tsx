...
export interface AvatarDropdownInfluencerProps {
  influencerDataProp?: string;
  onClickClose?: () => void
}

const AvatarDropdownInfluencer: FC<AvatarDropdownInfluencerProps> = ({influencerDataProp, onClickClose}) => {
    ...
    <div className="AvatarDropdown">
      <Popover className="relative">
        {({ open }) => (
          <>
            <Popover.Button
              className={`inline-flex items-center focus:outline-none focus-visible:ring-2 focus-visible:ring-transparent focus-visible:ring-opacity-75`}
            >
              <Avatar
                imgUrl={influencer.img || "https://res.cloudinary.com/newlink/image/upload/v1678639550/user.jpg"}
                  ...
                  <div className="relative grid grid-cols-1 gap-6 px-6 bg-white dark:bg-neutral-800 py-7">
                    <a href={"/dashboard"} className="flex items-center space-x-3">
                      ...
                      <div className="flex-grow">
                        <h4 className="font-bold">{influencer.username || "User"}</h4>
                        <p className="mt-2 text-xs">Logged In</p>
                      </div>
                    </a>
                    ...
                    >
                      <div className="flex items-center justify-center flex-shrink-0 text-neutral-500 dark:text-neutral-300">
                        <MdOutlineSpaceDashboard className="pl-0.5" fontSize="22px" />
                      </div>
                      <div className="ml-4">
                        <p className="pl-0.5 text-sm font-medium ">{"Dashboard"}</p>
                      </div>
                    </Link>
                    ...
                    >
                      <div className="flex items-center justify-center flex-shrink-0 text-neutral-500 dark:text-neutral-300">
                        <TbBrandBooking className="pl-0.5" fontSize="22px" />
                      </div>
                      <div className="ml-4">
                        <p className="pl-0.5 text-sm font-medium ">{"My Bookings"}</p>
                      </div>
                    </Link>
                    ...
                    <div className="flex items-center p-2 -m-3 transition duration-150 ease-in-out rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-700 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50">
                      ...
                      <div className="ml-4">
                        <p className="text-sm font-medium" onClick={handleLogOut}>Logout</p>
                      </div>
                    </div>
                  </div>
                </div>
...
export default AvatarDropdownInfluencer;
