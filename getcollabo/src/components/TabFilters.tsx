        ...
        {({ open, close }) => (
          <>
            ...
            >
              ...
              <span className="ml-2">Audience Count</span>
              {!saleTypeStates.length ? (
                ...
                <div className="overflow-hidden bg-white border shadow-xl rounded-2xl dark:bg-neutral-900 border-neutral-200 dark:border-neutral-700">
                  <div className="relative flex flex-col px-5 py-6 space-y-5">
                    <Checkbox
                      name="All"
                      label="All"
                      defaultChecked={saleTypeStates.includes("Audience Count")}
                      onChange={(checked) =>
                        handleChangeSaleType(checked, "Audience Count")
                      }
                    />
        ...
        {({ open, close }) => (
          <>
            ...
            >
              ...
              <span className="ml-2">Audience Platform</span>
              {!fileTypesState.length ? (
                <ChevronDownIcon className="w-4 h-4 ml-3" />
              ) : (
        ...
        {({ open, close }) => (
          <>
            ...
            >
              ...
              <span className="ml-2">{`${rangePrices[0]} NGN - ${rangePrices[1]} NGN`}</span>
              {renderXClear()}
            </Popover.Button>
            <Transition
              as={Fragment}
  ...
  const renderTabVerifiedCreator = () => {
    return (
      ...
      >
        ...
        <span className="ml-2 line-clamp-1">Verified influencer</span>
  ...
  const renderTabMobileFilter = () => {
    return (
      <div className="flex-shrink-0">
        ...
        >
          <span>
            <span className="hidden sm:inline">Influencer</span> filters (3)
          </span>
          {renderXClear()}
        </div>
                ...
                <div className="inline-flex flex-col w-full h-full max-w-4xl overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl dark:bg-neutral-900 dark:border dark:border-neutral-700 dark:text-neutral-100">
                  ...
                  <div className="flex-grow overflow-y-auto">
                    <div className="px-8 divide-y md:px-10 divide-neutral-200 dark:divide-neutral-800">
                      ...
                      {/* ---- */}
                      <div className="py-7">
                        <h3 className="text-xl font-medium">Audience Count</h3>
                      ...
                      {/* ---- */}
                      <div className="py-7">
                        <h3 className="text-xl font-medium">Audience Platform</h3>
                        <div className="relative mt-6 ">
