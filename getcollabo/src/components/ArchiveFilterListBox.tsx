...
const ArchiveFilterListBox: FC<ArchiveFilterListBoxProps> = ({
  ...
  const [selected, setSelected] = useState(lists[1]);
  return (
    <div
      ...
      <Listbox value={selected} onChange={setSelected}>
        <div className="relative md:min-w-[200px]">
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <Listbox.Options className="absolute right-0 z-20 py-1 mt-2 overflow-auto text-sm bg-white shadow-lg w-52 text-neutral-900 dark:text-neutral-200 rounded-2xl max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-neutral-900 dark:ring-neutral-700">
